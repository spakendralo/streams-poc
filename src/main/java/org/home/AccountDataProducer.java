...
public class AccountDataProducer {

    public static final String ACCOUNTS_TOPIC = "accounts8";
    ...
    public void createCustomers() throws IOException, InterruptedException {
        ...
        while (true) {
            producer = new KafkaProducer<Integer, String>(
                    props);
            Thread.sleep(3000);
            Account account = createSingleAccount(customerList.get(rand.nextInt(customerList.size())));
            String string = getCustomerAsString(account);
            ProducerRecord<Integer, String> record = new ProducerRecord<Integer, String>(
                    ACCOUNTS_TOPIC, account.getId(), string);
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        AccountDataProducer helloProducer = new AccountDataProducer();
